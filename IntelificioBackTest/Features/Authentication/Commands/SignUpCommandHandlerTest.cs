...
public class SignUpCommandHandlerTest
{
    ...
    public async Task Handle_FailedSignUp_UserAlreadyExist()
    {
        ...
        result.Error.Should().BeEquivalentTo(AuthenticationErrors.AlreadyCreatedEmail(command.User.Email));
    }
    ...
    public async Task Handle_FailedSigUp_CreateFailed()
    {
        ...
        _ = _roleManager.Setup(x => x.FindByNameAsync(It.IsAny<string>()))
            .ReturnsAsync(new Role() { Name = "Administrador" });
